...
wav_type = '.wav'
wav_path = 'D://pythonws//ML_data//data//test_data//'
wav_name = ''
img_type = '.png'
img_path = 'D://pythonws//ML_data//data//test_data//'
img_name = ''
mod_path = 'D://pythonws//ML_data//data//'
...
if __name__ == '__main__':
    filename = '1581382033744817.wav'
    sound_to_wav(filename)
    cut_wav_only3sec()
    wav_to_mel()
    print(predict())
